...
def listen(args):
    ...
    maxnum_machine2 = 0#num_nodes/2 if num_nodes%2==0 else (num_nodes+1)/2##適宜変える
...
def get_opt_params_dict(df_cur, init_params_dict,fixed_params_dict):
    ...
    while True:
        E_list=[];params_list=[]
        for cx in [cx_init_prev,cx_init_prev,cx_init_prev]:
            for cy in [cy_init_prev,cy_init_prev,cy_init_prev]:
