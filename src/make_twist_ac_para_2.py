...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,machine_type,isInterlayer):##R3:t-shaped R4:slipped-parallel
    a_ = params_dict['a']; b_ = params_dict['b']; c = np.array([params_dict['cx'],params_dict['cy'],params_dict['cz']])
    R3 = params_dict.get('Rt',0.0); R4 =params_dict.get('Rp',0.0)
    A1 = params_dict['A1']; A2 = params_dict['A2']; A3 = params_dict['theta']
    ...
    monomer_array_it5 = get_monomer_xyzR_(monomer_name,c[0]+a_/2,c[1]-3*b_/2,c[2]+R3-2*R4,-A1,A2,-A3, phi2)
    monomer_array_it6 = get_monomer_xyzR_(monomer_name,c[0]-a_/2,c[1]-3*b_/2,c[2]-R3-R4,-A1,A2,-A3, phi2)
    ...
    dimer_array_it5 = np.concatenate([monomer_array_c1,monomer_array_it5])
    dimer_array_it6 = np.concatenate([monomer_array_c1,monomer_array_it6])
    ...
    line_list_dimer_it5 = get_xyzR_lines(dimer_array_it5,machine_type,file_description+'_it5')
    line_list_dimer_it6 = get_xyzR_lines(dimer_array_it6,machine_type,file_description+'_it6')
